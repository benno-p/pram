...
LEFT JOIN (
    ...
    where loc_date is not null and loc_id_user = '".$_SESSION['email']."' group by 1,2
...
LEFT JOIN (
    ...
    where car_date is not null and car_id_user = '".$_SESSION['email']."' group by 1,2
...
LEFT JOIN (
    ...
    from mares.photos l 
    where date_photo is not null and id_user = '".$_SESSION['email']."' group by 1,2
